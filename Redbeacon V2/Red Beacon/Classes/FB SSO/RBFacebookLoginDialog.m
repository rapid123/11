...
@implementation RBFacebookLoginDialog
...
- (id)initWithAppId:(NSString *)apiKey requestedPermissions:(NSString *)requestedPermissions delegate:(id<RBFacebookLoginDialogDelegate>)delegate {
    if ((self = [super initWithNibName:@"RBFacebookLoginDialog" bundle:[NSBundle mainBundle]])) {
        self.apiKey = apiKey;
...
- (void)login 
{   
    NSString *redirectUrlString = @"http://redbeacon-inc.com/";
