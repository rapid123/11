...
#define SHKRBFacebookUseSessionProxy  NO 
//#define SHKRBFacebookKey				@"176127829119240"
//#define SHKRBFacebookSecret			@"a535f362542abb47c040e4c8be185516"
#define SHKRBFacebookKey				@"240168819338184"
#define SHKRBFacebookSecret             @"a92f04e1d6ac8491771ab236eaa8df8c"
#define SHKRBFacebookSessionProxyURL  @""
...
#define SHKTwitterConsumerKey		@"euq13bbsNJIAIUAS4rfnA"
#define SHKTwitterSecret			@"pn5CGuXXy2aSWksKUGfc3aax0EgRLbzLCKIESyFsI0"
#define SHKTwitterCallbackUrl		@"http://www.redbeacon.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)
