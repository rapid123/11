...
- (id)initWithPhotos:(NSMutableArray *)photosArray {
	...
	if ((self = [super init])) {
        ...
        photos=[[NSMutableArray alloc]init];
         for (NSURL *filePath in photosArray) {
                    //[photos addObject:[MWPhoto photoWithFilePath:filePath]];
             [photos addObject:[MWPhoto photoWithURL:filePath]];
        }
...
- (id)initWithPhotosWithImage:(NSMutableArray *)photosArray {
    
	if ((self = [super init])) {
		
		// Store photos
        photos=[[NSMutableArray alloc]init];
        for (UIImage *filePath in photosArray) {
            //[photos addObject:[MWPhoto photoWithFilePath:filePath]];
             [photos addObject:[MWPhoto photoWithImage:filePath]];
        }
...
-(void)createRightNavigationButton {
    ...
    UIButton * button = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 58, 30)];
...
- (void)viewDidLoad {
    ...
    [self createRightNavigationButton];   // to adjust the title (red beacon)
...
- (void)updateNavigation {
    ...
    [self.navigationItem setRBTitle:self.title];
